...
export class EditProjectTypeComponent implements OnInit {
  ...
  ProjectTypeId = this.activeRoute.snapshot.params['id'];
  constructor(private router: Router,private projectTypeService:ProjectTypeService
    ...
    ngOnInit(): void {
      ...
      this.projectTypeService.GetprojectTypeByID(this.ProjectTypeId).subscribe(
    ...
    update() {
      this.projectTypeService.UpdateprojectType(this.ProjectTypeId,this.ProjectTypeObj).subscribe(
        res => {
