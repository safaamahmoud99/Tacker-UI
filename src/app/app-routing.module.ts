...
const routes: Routes = [
  ...
  { path: 'Resetpassword', component: ResetPasswordComponent }, 
  {
    path: 'home', component: HomeComponent, children: [
      ...
      { path: 'DisplayDepartments', component: DisplayDepartmentsComponent,canActivate:[basic], data:{role:[Roles.SuperAdmin,Roles.Admin]} },
      { path: 'editDepartment/:id', component: EditDepartmentComponent,canActivate:[basic], data:{role:[Roles.SuperAdmin]} },
      { path: 'ProjectTypes', component: ProjectTypeComponent,canActivate:[basic] , data:{role:[Roles.SuperAdmin,Roles.Admin,Roles.PMO,Roles.PM]}},
      { path: 'addProjectType', component: AddProjectTypeComponent,canActivate:[basic], data:{role:[Roles.SuperAdmin,Roles.Admin]} },
      { path: 'editProjectType/:id', component: EditProjectTypeComponent,canActivate:[basic], data:{role:[Roles.SuperAdmin,Roles.Admin]} },
      { path: 'Requests', component: CreateRequesteComponent ,canActivate:[basic], data:{role:[Roles.SuperAdmin]}},
      ...
      { path: 'createProject', component: CreateProjectComponent,canActivate:[basic], data:{role:[Roles.SuperAdmin,Roles.Admin,Roles.PMO]}},
      { path: 'updateproject/:id', component: UpdateProjectComponent,canActivate:[basic], data:{role:[Roles.SuperAdmin,Roles.Admin,Roles.PMO]}},
      { path: 'AllUsers', component: AllUsersComponent,canActivate:[basic], data:{role:[Roles.SuperAdmin,Roles.Admin]} },
      { path: 'DisplayAllClients', component: DisplayAllClientsComponent,canActivate:[basic], data:{role:[Roles.SuperAdmin,Roles.Admin,Roles.PMO]}},
      { path: 'AllManagersReq', component: AllManagerRequestsComponent,canActivate:[basic], data:{role:[Roles.SuperAdmin,Roles.Admin,Roles.PMO]} },
      { path: 'AllClientsReq', component: ClientCreateRequestComponent,canActivate:[basic],data:{role:[Roles.SuperAdmin]} },
      { path: 'assignReq/:reqId', component: AssignRequestsComponent,canActivate:[basic],data:{role:[Roles.SuperAdmin,Roles.TL]} },
      { path: 'employee', component: DisplayAllEmployeesComponent,canActivate:[basic],data:{role:[Roles.SuperAdmin,Roles.Admin]} },
      { path: 'addemployee', component: AddEmployeeComponent,canActivate:[basic],data:{role:[Roles.SuperAdmin,Roles.Admin]}},
      { path: 'profile', component: ProfileComponent,canActivate:[basic], data:{role:[Roles.SuperAdmin,Roles.Admin,Roles.PMO,Roles.PM,Roles.TL,Roles.ClientManager,Roles.Client]} },
      { path: 'projectManagerDashboard', component: ProjectmanagerDashboardComponent,canActivate:[basic], data:{role:[Roles.SuperAdmin,Roles.PM]} },
      { path: 'teamLeaderDashboard', component: TeamleaderDashboardComponent,canActivate:[basic], data:{role:[Roles.SuperAdmin,Roles.TL]} },
      { path: 'allClientReqts', component: AllClientRequestsComponent,canActivate:[basic], data:{role:[Roles.SuperAdmin,Roles.Admin,Roles.Client,Roles.ClientManager]} },
      { path: 'organization', component: AddOrganizationComponent,canActivate:[basic], data:{role:[Roles.SuperAdmin,Roles.Admin]} },
      { path: 'organizations', component: ListOrganizationsComponent,canActivate:[basic], data:{role:[Roles.SuperAdmin]} },
      // { path: 'organization', component: AddOrganizationComponent,canActivate:[AuthGuard] },
      { path: 'editOrganization/:id', component: EditOrganizationComponent,canActivate:[basic], data:{role:[Roles.SuperAdmin,Roles.Admin]}  },
      { path: 'editEmployee/:empId', component: EditEmployeeComponent,canActivate:[basic], data:{role:[Roles.SuperAdmin,Roles.Admin]}  },
      ...
      { path: 'DisplayAssets', component: DisplayAssetsComponent,canActivate:[basic] ,data:{role:[Roles.SuperAdmin,Roles.Admin,Roles.PMO,Roles.PM]}},
      { path: 'Sites', component: SitesComponent,canActivate:[basic],data:{role:[Roles.SuperAdmin,Roles.Admin]} },
      { path: 'Origins', component: OriginsComponent,canActivate:[basic],data:{role:[Roles.SuperAdmin,Roles.Admin]}},
      { path: 'Suppliers', component: SuppliersComponent,canActivate:[basic],data:{role:[Roles.SuperAdmin,Roles.Admin]} },
      // { path: 'DueDateCategory', component: DueDateCategoryComponent },
      { path: 'Brand', component: BrandComponent,canActivate:[basic],data:{role:[Roles.SuperAdmin,Roles.Admin]} },
      { path: 'ClientManagerRequests/:projectId', component: ClientManagerRequestsComponent ,canActivate:[basic],data:{role:[Roles.SuperAdmin,Roles.Admin,Roles.ClientManager]}},
      { path: 'ClientManagerComponent', component: ClientManagerComponent,canActivate:[basic],data:{role:[Roles.SuperAdmin,Roles.Admin,Roles.ClientManager]} },
